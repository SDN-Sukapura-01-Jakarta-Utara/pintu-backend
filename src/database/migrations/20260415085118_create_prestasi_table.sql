...
CREATE TABLE prestasi (
    ...
    peserta_didik_rombel_id INTEGER,
    ...
    CONSTRAINT fk_prestasi_peserta_didik_rombel FOREIGN KEY (peserta_didik_rombel_id) REFERENCES peserta_didik_rombel(id) ON DELETE SET NULL,
...
CREATE INDEX idx_prestasi_peserta_didik_rombel_id ON prestasi(peserta_didik_rombel_id);
