...
func (s *PermissionSeeder) Run() error {
	...
	permissions := []Permission{
		...
		{Name: "UPDATE_INFORMASI_SEKOLAH", Description: "Update school information", GroupName: "INFORMASI_SEKOLAH", SystemID: 1, Status: "active"},
		{Name: "DELETE_INFORMASI_SEKOLAH", Description: "Delete school information", GroupName: "INFORMASI_SEKOLAH", SystemID: 1, Status: "active"},

		// Media
		{Name: "CREATE_MEDIA_PUBLIKASI", Description: "Create media & publikasi", GroupName: "MEDIA_PUBLIKASI", SystemID: 1, Status: "active"},
		{Name: "READ_MEDIA_PUBLIKASI", Description: "Read media & publikasi", GroupName: "MEDIA_PUBLIKASI", SystemID: 1, Status: "active"},
		{Name: "UPDATE_MEDIA_PUBLIKASI", Description: "Update media & publikasi", GroupName: "MEDIA_PUBLIKASI", SystemID: 1, Status: "active"},
		{Name: "DELETE_MEDIA_PUBLIKASI", Description: "Delete media & publikasi", GroupName: "MEDIA_PUBLIKASI", SystemID: 1, Status: "active"},

		// Kepegawaian
		{Name: "CREATE_KEPEGAWAIAN", Description: "Create employee data", GroupName: "KEPEGAWAIAN", SystemID: 1, Status: "active"},
		{Name: "READ_KEPEGAWAIAN", Description: "Read employee data", GroupName: "KEPEGAWAIAN", SystemID: 1, Status: "active"},
		{Name: "UPDATE_KEPEGAWAIAN", Description: "Update employee data", GroupName: "KEPEGAWAIAN", SystemID: 1, Status: "active"},
		{Name: "DELETE_KEPEGAWAIAN", Description: "Delete employee data", GroupName: "KEPEGAWAIAN", SystemID: 1, Status: "active"},

		// Peserta Didik
		{Name: "CREATE_PESERTA_DIDIK", Description: "Create student data", GroupName: "PESERTA_DIDIK", SystemID: 1, Status: "active"},
		{Name: "READ_PESERTA_DIDIK", Description: "Read student data", GroupName: "PESERTA_DIDIK", SystemID: 1, Status: "active"},
		{Name: "UPDATE_PESERTA_DIDIK", Description: "Update student data", GroupName: "PESERTA_DIDIK", SystemID: 1, Status: "active"},
		{Name: "DELETE_PESERTA_DIDIK", Description: "Delete student data", GroupName: "PESERTA_DIDIK", SystemID: 1, Status: "active"},

		// Mutasi Siswa
		{Name: "CREATE_MUTASI_SISWA", Description: "Create student mutation", GroupName: "MUTASI_SISWA", SystemID: 1, Status: "active"},
		{Name: "READ_MUTASI_SISWA", Description: "Read student mutation", GroupName: "MUTASI_SISWA", SystemID: 1, Status: "active"},
